...
- 🚧 **Phase 6** — Polish.
  ...
  - ⏭ **Tournament-end awards screen** (top run scorer / top wicket taker / best figures / Player of the Tournament — all derivable from existing data, no schema change). Wagon wheel (needs scoring-page tap-zone capture), commentary feed, audit log UI.
